...
[
    ...
    {sponsorName: 'boi', sponsorCategory: 'gold', companyLogoURL:'https://africanbusinessmagazine.com/wordpress/wp-content/uploads/2019/04/boi.png',companyLightLogoURL:'http://ic-events.net/wordpress/wp-content/uploads/2018/02/adf-light.png', companyURL:'https://www.boi.ng', postID:'229293'}
                ...
                <Landing id="landing-section" template="threequarter-screen-left" extraBgElements={extraHTML}>
                    <div className="col-sm-offset-2 col-md-offset-3 col-xs-12 col-sm-8 col-md-6 landingtext">
                        ...
                        <div className="entryinfo">
                            <p>Call for entries are now closed. Please see below the shortlisted nominees for each category.</p> 
                        ...
                        <div id="hoteldets">
                            <div className="col-xs-12 col-sm-12 col-sm-offset-1">
                                ...
                                <p className="col-xs-12 col-sm-12">
                                    After a jam packed and successful event last year in Busan, South Korea; The African Banker Awards returns to the African continent and will take place in the the beautiful city of Malabo, Equatorial Guinea. 
                                </p>
